...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h2 class="h5 page-title">Update Category
                </h2>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.category.update',$category->id) }}" method="post" id="add_form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" class="border form-control" name="description"
                            placeholder="please enter description" value="{{ $category->description }}">
                    </div>
